...
//******************************************************************
/*
unsigned char SD_readSingleBlockAndSend(unsigned long startBlock, unsigned long byteCounter, unsigned long fileSize)
{
unsigned char response;
unsigned int i, retry=0;
...
//******************************************************************
/*
unsigned char SD_readPartialBlock(unsigned long startBlock)
{
unsigned char response;
unsigned int i, retry=0;
